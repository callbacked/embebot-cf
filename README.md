...
[![](https://github.com/callbacked/embebot/blob/main/assets/add.png)](https://discord.com/oauth2/authorize?client_id=1100908930458198098&permissions=27648&integration_type=0&scope=bot) (or if you want to just add the bot to your server)
